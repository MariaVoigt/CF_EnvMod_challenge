...
<table style="border-collapse: collapse;">
  <tr>
    <th style="padding: 20px; border: 1px solid black;">Layer Name</th>
    <th style="padding: 20px; border: 1px solid black;">Resolution (lon)</th>
    <th style="padding: 20px; border: 1px solid black;">Resolution (lat)</th>
    <th style="padding: 20px; border: 1px solid black;">Extent (lon)</th>
    <th style="padding: 20px; border: 1px solid black;">Extent (lat)</th>
  </tr>
  <tr>
    ...
    <td style="padding: 5px; border: 1px solid black;">`r round(ext(local_env_1$evapotransp_pt)[2], 4)`</td>
  </tr>
  <tr>
    ...
    <td style="padding: 5px; border: 1px solid black;">`r round(ext(local_env_1$landcover_pt)[2], 4)`</td>
  </tr>
  <tr>
    ...
    <td style="padding: 5px; border: 1px solid black;">`r round(ext(local_env_1$SOC_pt)[2], 4)`</td>
  </tr>
</table>
