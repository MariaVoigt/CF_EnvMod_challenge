...
I can also look at soil organic carbon per landcover class. As there is only one time point for this layer I used a bar plot for visualisation.
...
```
Errorbars show the standard deviation around the mean per class.
